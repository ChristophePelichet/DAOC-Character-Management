...
✅ **Charaktername** in Backup-Dateinamen enthalten  
✅ Einzeloperationen: `backup_characters_20251107_143025_Update_Merlin.zip`  
✅ Massenoperationen: `backup_characters_20251107_143025_Update_multi.zip`  
✅ Sofortige Identifizierung des betroffenen Charakters  
✅ Einfachere Navigation im Backup-Verlauf  

## 🔧 Kritische Herald-Such-Korrekturen (7. Nov 2025)
✅ **KRITISCHER FIX**: Brutaler Absturz bei Herald-Suchfehlern behoben  
✅ Ordnungsgemäßes Schließen des WebDrivers in allen Fehlerpfaden  
✅ Vollständiges Stacktrace-Logging für Diagnosen  
✅ Stabilitätstest: 25/25 Suchen erfolgreich (100% stabil)  
✅ Automatisiertes Testskript für kontinuierliche Validierung  

## 🔧 Kritische Backup-Korrekturen (7. Nov 2025)
✅ **KRITISCHER FIX**: Pfadauflösung für Backups (komplett defekt)  
✅ Automatische Backups bei Erstellen/Aktualisieren/Löschen funktionieren jetzt  
✅ Manuelle Sicherung funktioniert korrekt  
✅ Verbesserte Logs: INFO statt ERROR beim ersten Start  
✅ Backup-Verzeichnis-Erstellungslogs jetzt sichtbar  
✅ Klare Fehlermeldung: "No characters to backup" statt "folder not found"  

## ⚡ Herald-Leistungsoptimierung - Phase 1 (8. Nov 2025)
✅ **Herald-Timeout-Reduzierung um 17.4%** (-4.6 Sekunden pro Suche)  
✅ **25/25 Tests erfolgreich** (100% stabil, 0 Abstürze)  
✅ **Charaktersuche: 26.5s → 21.9s** (-4.6 Sekunden, -17.4%)  
✅ **7 Timeout-Optimierungen angewendet**:  
   • Homepage: 2s → 1s  
   • **Sleep vor Refresh ENTFERNT** (Hauptgewinn)  
   • Refresh: 3s → 2s  
   • Herald-Laden: 4s → 2s  
   • Test-Homepage: 2s → 1s  
   • Test-Refresh: 3s → 2s  
   • Test-Herald: 5s → 3s  
✅ **Insgesamt gespart: 1.9 Minuten bei 25 Suchen**  
✅ Vollständige Validierung nach WebDriver-Absturz-Korrektur  
✅ Dokumentation: HERALD_PHASE1_TEST_REPORT.md  
✅ Automatisiertes Testskript: Scripts/test_herald_stability.py  
