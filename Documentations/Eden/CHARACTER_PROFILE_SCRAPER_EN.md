...
1. **`_connect_to_eden_herald()`** - Establishes connection (see [CONNECT_TO_EDEN_HERALD_EN.md](CONNECT_TO_EDEN_HERALD_EN.md))
2. **`search_herald_character()`** - Searches for characters (see [CHARACTER_SEARCH_SCRAPER_EN.md](CHARACTER_SEARCH_SCRAPER_EN.md))
3. **`_normalize_herald_data()`** - Normalizes character data
4. **`CharacterProfileScraper`** - Profile scraping and wealth management (see [CHARACTER_STATS_SCRAPER_EN.md](CHARACTER_STATS_SCRAPER_EN.md))
...
- **Connection**: [CONNECT_TO_EDEN_HERALD_EN.md](CONNECT_TO_EDEN_HERALD_EN.md) - `_connect_to_eden_herald()` function
- **Search**: [CHARACTER_SEARCH_SCRAPER_EN.md](CHARACTER_SEARCH_SCRAPER_EN.md) - `search_herald_character()` function
- **Stats & Wealth**: [CHARACTER_STATS_SCRAPER_EN.md](CHARACTER_STATS_SCRAPER_EN.md) - `CharacterProfileScraper` class
